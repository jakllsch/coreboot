	...
	Scope (\_SB)
	{
		Device (N0L2)
		{
			...
			Method (_BBN, 0, NotSerialized) {
				Return (GBUS (GHCN(0x00), GHCL(0x01)))
			}
			...
			Method (_CRS, 0, Serialized)
			{
				...
				Concatenate (\_SB.GMEM (0x00, GHCL(0x01)), BUF0, Local1)
				Concatenate (\_SB.GIOR (0x00, GHCL(0x01)), Local1, Local2)
				Concatenate (\_SB.GWBN (0x00, GHCL(0x01)), Local2, Local3)
				Return (Local3)
			}

			/* PCI Routing Table */
			Name (_PRT, Package () {
				Package (0x04) { 0x0001FFFF, 0x01, 0x00, 0x2A }, /* 0x1 - 00:01.1 - IRQ 10 - SMBus */
				Package (0x04) { 0x0002FFFF, 0x00, 0x00, 0x36 }, /* 0x2 - 00:02.0 - IRQ 22 - USB */
				Package (0x04) { 0x0002FFFF, 0x01, 0x00, 0x37 }, /* 0x2 - 00:01.1 - IRQ 23 - USB */
				Package (0x04) { 0x0004FFFF, 0x00, 0x00, 0x35 }, /* 0x4 - 00:04.0 - IRQ 21 - IDE */
				Package (0x04) { 0x0005FFFF, 0x00, 0x00, 0x34 }, /* 0x5 - 00:05.0 - IRQ 20 - SATA */
				Package (0x04) { 0x0005FFFF, 0x01, 0x00, 0x35 }, /* 0x5 - 00:05.1 - IRQ 21 - SATA */
				Package (0x04) { 0x0005FFFF, 0x02, 0x00, 0x36 }, /* 0x5 - 00:05.2 - IRQ 22 - SATA */
				Package (0x04) { 0x0006FFFF, 0x01, 0x00, 0x37 }, /* 0x6 - 00:06.1 - IRQ 23 - HD Audio */
				Package (0x04) { 0x0008FFFF, 0x00, 0x00, 0x34 }, /* 0x8 - 00:08.0 - IRQ 20 - GBit Ethernet */
				Package (0x04) { 0x0009FFFF, 0x00, 0x00, 0x34 }, /* 0x9 - 00:09.0 - IRQ 20 - GBit Ethernet */
			})

			Device (PBEF) /* PCI-E Bridge F */
			{
				Name (_ADR, 0x000F0000)
				Name (_UID, 0x00)
				Name (_PRT, Package () {
					Package (0x04) { 0x0000FFFF, 0x00, 0x00, 0x31 },
			...
			Device (PBEE) /* PCI-E Bridge E */
			{
				Name (_ADR, 0x000E0000)
				Name (_UID, 0x00)
				Name (_PRT, Package () {
					Package (0x04) { 0x0000FFFF, 0x00, 0x00, 0x32 },
			...
			Device (PBED) /* PCI-E Bridge D */
			{
				Name (_ADR, 0x000D0000)
				Name (_UID, 0x00)
				Name (_PRT, Package () {
					Package (0x04) { 0x0000FFFF, 0x00, 0x00, 0x33 },
			...
			Device (PBEC) /* PCI-E Bridge C */
			{
				Name (_ADR, 0x000C0000)
				Name (_UID, 0x00)
				Name (_PRT, Package () {
					Package (0x04) { 0x0000FFFF, 0x00, 0x00, 0x30 },
					Package (0x04) { 0x0000FFFF, 0x01, 0x00, 0x31 },
					Package (0x04) { 0x0000FFFF, 0x02, 0x00, 0x32 },
					Package (0x04) { 0x0000FFFF, 0x03, 0x00, 0x33 },
				})
			}

			Device (PBEB) /* PCI-E Bridge B */
			{
		...
		Device (PCI0)
		{
			...
			Name (_UID, 0x00)
			Method (_BBN, 0, NotSerialized) {
				Return (GBUS (GHCN(0x00), GHCL(0x00)))
			}
